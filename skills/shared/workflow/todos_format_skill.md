---
name: todos-format
description: Canonical TODOS.md format reference. Use when creating or updating TODOS.md — defines the standard structure for TODO items shared across /ship and /plan-ceo-review workflows.
---
