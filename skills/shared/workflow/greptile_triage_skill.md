---
name: greptile-triage
description: Greptile review comment triage. Shared reference for fetching, filtering, and classifying Greptile AI review comments on GitHub PRs. Used by /review (Step 2.5) and /ship (Step 3.75).
---
