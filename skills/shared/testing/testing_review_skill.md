---
name: testing-review
description: Testing specialist review. Always-on for every code review — checks test coverage gaps, missing edge cases, brittle assertions, test isolation, and whether new code paths have corresponding tests.
---
