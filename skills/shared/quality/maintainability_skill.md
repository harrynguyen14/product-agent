...
description: Maintainability specialist review. Always-on for every code review — checks code complexity, naming clarity, dead code, coupling, abstraction quality, and long-term readability.
---
