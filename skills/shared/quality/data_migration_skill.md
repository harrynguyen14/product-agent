...
description: Data migration specialist review. Use when reviewing database migrations — checks safety, rollback strategy, zero-downtime patterns, index creation, and data integrity. Triggered when SCOPE_MIGRATIONS=true.
---
