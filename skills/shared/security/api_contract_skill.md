...
description: API contract specialist review. Use when reviewing API changes — checks breaking changes, versioning, schema consistency, backward compatibility, and contract violations. Triggered when SCOPE_API=true.
---
