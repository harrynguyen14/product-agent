...
description: Performance specialist review. Use when reviewing backend or frontend changes — checks N+1 queries, missing indexes, unnecessary re-renders, bundle size, caching opportunities, and algorithmic complexity. Triggered when SCOPE_BACKEND=true or SCOPE_FRONTEND=true.
---
