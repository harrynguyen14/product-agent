---
name: pr-checklist
description: Pre-landing PR review checklist. Use before merging any PR — checks for common bugs, security issues, missing tests, style violations, and correctness against git diff origin/main.
---
