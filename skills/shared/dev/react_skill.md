---
name: react-pattern
description: ReAct (Reasoning + Acting) pattern for agents. Use when implementing or debugging an agent that interleaves Thought, Action, and Observation steps in a loop to adaptively gather information before producing a final answer.
---
