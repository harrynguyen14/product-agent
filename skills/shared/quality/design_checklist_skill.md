...
description: Design review checklist for frontend changes. Use when reviewing UI/UX — checks visual hierarchy, spacing, typography, accessibility, responsive behavior, and interaction states. Triggered when SCOPE_FRONTEND=true.
---
