...
description: Security specialist review. Use when reviewing auth changes or large backend diffs — checks injection vulnerabilities, authentication flaws, authorization bypasses, secrets exposure, and OWASP top 10. Triggered when SCOPE_AUTH=true or (SCOPE_BACKEND=true and diff > 100 lines).
---
